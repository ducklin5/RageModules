...
struct RefluxWidget : ModuleWidget {
	RefluxWidget(Reflux* module) {
		...
		for (int i = 0; i < Reflux::NUM_TRIGIN; i++) {
		...
		addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(6.25, 107.25)), module, Reflux::TRIG_OUTPUT));
		addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(16.25, 107.25)), module, Reflux::OUTA_OUTPUT));
		addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(25.0, 107.25)), module, Reflux::OUTB_OUTPUT));
	}
};
